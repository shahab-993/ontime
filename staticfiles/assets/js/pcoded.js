...
function changeIconTo(theme) {
    const useElement = document.querySelector('#theme-icon use');
    if (useElement) {
        if (theme === 'dark') {
            useElement.setAttribute('href', '#custom-moon');
        } else if (theme === 'light') {
            useElement.setAttribute('href', '#custom-sun-1');
        } else {
            useElement.setAttribute('href', '#custom-setting-2');
        }
    }
}
