    ...
    var l = {
        ...
        messages: {
            missingValue: {
                ...
                "select-multiple": gettext("Please select at least one value."),
        ...
        return c(arguments, (function (e) {
            for (var t in e) {
                ...
                "[object Object]" === Object.prototype.toString.call(e[t]) ? r[t] = s(r[t], e[t]) : r[t] = e[t]
            }
        })), r
    }, f = function (e, t, r) {
        if ("function" == typeof a.CustomEvent) {
            var n = new CustomEvent(t, {bubbles: !0, detail: r || {}});
            e.dispatchEvent(n)
        }
    }, d = function (e, t) {
        return {
        ...
        r.className = t.errorClass, r.id = t.errorPrefix + x(e, t, !0);
        ...
        var n, a, i, o = e.form.querySelector("#" + m(r.errorPrefix + x(e, r))) || v(e, r), u = (function (e, t, r) {
            var n = r.messages;
        ...
        o.textContent = "function" == typeof u ? u(e, r) : u, a = o, i = r, "radio" === (n = e).type && n.name && Array.prototype.forEach.call(document.querySelectorAll('[name="' + n.name + '"]'), (function (e) {
            h(e, a, i)
        })), h(n, a, i), r.emitEvents && f(e, "bouncerShowError", {errors: t})
    }, i = function (e, t) {
        e.classList.remove(t.fieldClass), e.removeAttribute("aria-describedby"), e.removeAttribute("aria-invalid")
    }, b = function (e, t) {
        var r, n, a = e.form.querySelector("#" + m(t.errorPrefix + x(e, t)));
    ...
    return function (n, e) {
        ...
        r.validate = function (e, t) {
            if (!e.disabled && !e.readOnly && "reset" !== e.type && "submit" !== e.type && "button" !== e.type) {
                var r, n, a, i = s(u, t || {}), o = (a = d(r = e, n = i), {
                    valid: !(function (e) {
                        ...
                        return t
                    })(r, a, n.customValidations, n)), errors: a
                });
        ...
        var a = function (e) {
            ...
            e.target.form && e.target.form.matches(n) && e.target.classList.contains(u.fieldClass) && r.validate(e.target)
        }, o = function (e) {
            if (e.target.matches(n)) {
                e.preventDefault();
                var t = r.validateAll(e.target);
                if (0 < t.length) return t[0].focus(), void f(e.target, "bouncerFormInvalid", {errors: t});
                u.disableSubmit || e.target.submit(), u.emitEvents && f(e.target, "bouncerFormValid")
            }
        };
        r.destroy = function () {
            var e, t, r;
            document.removeEventListener("blur", a, !0), document.removeEventListener("input", i, !1), document.removeEventListener("click", i, !1), document.removeEventListener("submit", o, !1), e = n, t = u, c(document.querySelectorAll(e), (function (e) {
                c(e.querySelectorAll("input, select, textarea"), (function (e) {
                    b(e, t)
                }))
            })), r = n, c(document.querySelectorAll(r), (function (e) {
                e.removeAttribute("novalidate")
            })), u.emitEvents && f(document, "bouncerDestroyed", {settings: u}), u = null
        };
        var t;
        return u = s(l, e || {}), t = n, c(document.querySelectorAll(t), (function (e) {
            e.setAttribute("novalidate", !0)
        })), document.addEventListener("blur", a, !0), document.addEventListener("input", i, !1), document.addEventListener("click", i, !1), document.addEventListener("submit", o, !1), u.emitEvents && f(document, "bouncerInitialized", {settings: u}), r
    }
}));